    ...
    public void Remove(int value)
    {
        ...
        while (curr is not null)
        {
            if (curr.Data == value)
            {
                if (curr == _head)
                {
                    // It's the head, use RemoveHead
                    RemoveHead();
                }
                else if (curr == _tail)
                {
                    // It's the tail, use RemoveTail
                    RemoveTail();
                }
                else
                {
                    // It's in the middle, stitch neighbors together
                    curr.Prev!.Next = curr.Next; // Left neighbor points forward past curr
                    curr.Next!.Prev = curr.Prev; // Right neighbor points backward past curr
                }
    ...
    public void Replace(int oldValue, int newValue)
    {
        ...
        while (curr is not null)
        {
            if (curr.Data == oldValue)
            {
                ...
                // No return here — keep going to find all matches
            }
            curr = curr.Next; // Move to next node
        }
    }
